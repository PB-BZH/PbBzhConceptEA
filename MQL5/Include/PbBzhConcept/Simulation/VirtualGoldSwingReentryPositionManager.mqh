//+------------------------------------------------------------------+
//|          VirtualGoldSwingReentryPositionManager.mqh                 |
//|  Momentum GOLD LONG, coûts et rapport de robustesse automatique |
//+------------------------------------------------------------------+
#ifndef PB_BZH_VIRTUAL_GOLD_SWING_REENTRY_POSITION_MANAGER_MQH
#define PB_BZH_VIRTUAL_GOLD_SWING_REENTRY_POSITION_MANAGER_MQH
